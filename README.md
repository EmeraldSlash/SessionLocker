...
- A library does not provide facilities for robust product processing or reliable data saving
...
- The use of singletons and globals is avoided so that all inputs can be configured by usage code.
